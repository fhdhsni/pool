%%
% - The server's job will be to maintain the counter of how many workers are in the pool.
%
% - should also hold the queue of tasks.
%
% - Running a task in the pool and telling you it can't be started if
%   the pool is full ==> run/2
%
...
%   no place is available, queue it up and run it whenever. ==> async_queue/2
%%
-module(ppool_serv).
